...
Note: Before downloading and installing plugin, you must accept that plugin sends your website url (using site_url()), website name (using get_bloginfo('name')) automatically when you blacklist any IP to https://www.ip-finder.me and show this on relative blacklisted IP. (Example: https://www.ip-finder.me/203.81.202.127/)
...
= 5.00 =
* Minor updates and tested on WordPress 5.4.1
